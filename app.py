...
st.write("##### That is " +str(round(balance_track[-1]-initialBalance)) + "$ in " + chartPeriod + " (" + str(round((balance_track[-1]-initialBalance)/initialBalance*100,1)) + "%). This ticker did " + str(round((price[-1]-price[0])/price[0]*100,1)) + "% in that time.")
